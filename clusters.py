...
# odczyt pliku z danymi i ekstrakcja zeń listy obiektów (blogów), listy słów i ich liczby w blogu
...
# Tanimoto coefficient - the ratio of the intersection set (only the items that are in both sets)
...
# skalowanie wielowymiarowe (multidimensional scaling)
...
# drawing the multidimensional scaling
